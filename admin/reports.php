        ...
        <div id="sidebar" class="main-pg">
            ...
            <div id="sidebar" class="sidebar">
                ...
                <form>
                    <div class="dock">
                        <div class="head-cen">
                            <span><center>Reports</center></span>
                        </div><br><br>
                        <table>
                            <thread>
                            <tr>
                            ...
                            $s2="select * from crtps where clg_approved='done' && admin_approved='yes'";
                            $sque=mysqli_query($con,$s2);
                            $snum=mysqli_num_rows($sque);
                            

                            if($snum>0){
                                $sel="select * from crtps where clg_approved='done' && admin_approved='yes'";
        ...
        <div id="sidebar2" class="wrapper">
            <div class="navbar">
                ...
                <ul>
                    ...
                    <li>
                     <a href="reports.html"  class="til-4">
